...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', # used for deployment
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #used for deployment
...
EMAIL_HOST_PASSWORD = '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'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
